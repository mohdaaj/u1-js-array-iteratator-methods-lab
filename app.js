...
veryOldInventors = inventors.filter((years1500and1599) =>{

    return (years1500and1599.year >= 1500) && (years1500and1599.year <= 1599);
})
...
// Complete the exercise in the space below:
inventorNames = inventors.map((namee)=> {
   
 return `{ first: ${namee.first}, last: ${namee.last} }.`
})
...
// Complete the exercise in the space below:
inventorNamedAda = inventors.find((nameada)=>{
     return nameada.first === 'Ada';
})
...
firstLast = people.map((names)=>{
     let firslas = names.split(', ');
    return `${firslas[1]} ${firslas[0]}`
})
...
// Complete the exercise in the space below:
isAdultPresent = devs.some((ages)=>{
   return 2025 - ages.year >= 18; 
})
...
// Complete the exercise in the space below:
isEveryone19OrOlder = devs.every((agesmorethan19)=> {
   return 2025 - agesmorethan19.year  >= 19 ; 
...
// Complete the exercise in the space below:
commentById = comments.find((fiid)=> {
    return fiid.id === 823423;
})
...
// Complete the exercise in the space below:
idx = comments.findIndex((fiindx)=> {
  return fiindx.id === 123523;
})
